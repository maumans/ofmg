...
class TuteurController extends Controller
{
    ...
    {
        $users=User::whereRelation("roles","libelle","tuteur")->orderByDesc("created_at")->with("roles","etablissement")->get();
        //$roles=Role::where("libelle","<>","etablissement")->where("libelle","<>","tuteur")->where("libelle","<>","personnel")->get();

        return Inertia::render('Etablissement/Tuteur/Index',["users"=>$users/*,"roles"=>$roles*/]);
