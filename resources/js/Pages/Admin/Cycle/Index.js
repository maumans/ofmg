...
function Index(props) {
    ...
    function handleSubmitEdit(){
        Inertia.put(route("admin.cycle.update",[props.auth.user.id,data.editId]),data,{preserveScroll:true});
        setOpen(false)
    }
    ...
    function handleSubmit(e)
    {
        ...
        post(route("admin.cycle.store",props.auth.user.id),{data,onSuccess: ()=>reset("libelle")})
