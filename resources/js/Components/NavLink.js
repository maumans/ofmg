...
export default function NavLink({ href, active, children }) {
    return (
        <Link
            ...
            className={
                active
                    ? 'inline-flex items-center px-1 pt-1 border-b-4 orangeOrangeBorder text-sm font-medium leading-5 orangeOrangeColor focus:outline-none focus:border-orange-700 transition duration-150 ease-in-out'
